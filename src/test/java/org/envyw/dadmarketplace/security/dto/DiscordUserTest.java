...
public class DiscordUserTest {
    ...
    public void shouldCreateDtoWithRequiredFields() {
        ...
        // when
        DiscordUser dto = new DiscordUser(id, username, avatarUrl, null, displayName);
    ...
    public void shouldCreateDtoWithAllFields() {
        ...
        // when
        DiscordUser dto = new DiscordUser(id, username, avatarUrl, email, displayName);
    ...
    public void shouldThrowExceptionWhenIdIsNull() {
        // when, then
        assertThatThrownBy(() -> new DiscordUser(null, "테스트유저", null, null, null))
    ...
    public void shouldThrowExceptionWhenUsernameIsNull() {
        // when, then
        assertThatThrownBy(() -> new DiscordUser("12345678", null, null, null, null))
                .isInstanceOf(NullPointerException.class);
    }
    ...
    public void shouldThrowExceptionWhenAvatarIsNull() {
        // when, then
        assertThatThrownBy(() -> new DiscordUser("12345678", "1234", null, null, null))
                .isInstanceOf(NullPointerException.class);
    }
}
